...
datagrid = """08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
d = [map(int, row.split()) for row in datagrid.splitlines()]
value = 0
for m in xrange(16):
    for n in xrange(16):
        value = max(value,
...
print "%d found in %s seconds" % (value,elapsed)
...
# 
# 
# k = "9 9 8 1 0 9 6 4 5 3 8 6 9 1 1 7 3 2 4 1 9 7 6 3 2"
#  
# a = k.split(" ")[:26]
#      
# x = int(a[0]) * int(a[1]) * int(a[2]) * int(a[3])
# y = int(a[0]) * int(a[5]) * int(a[10]) * int(a[15])
# z = int(a[0]) * int(a[6]) * int(a[12]) * int(a[18])
#  
# print "first ",max(x,y,z)
